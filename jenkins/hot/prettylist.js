...
[
  {
    ...
    pm2_env: {
      ...
      env: {
        ...
        npm_lifecycle_script: 'cross-env name=source_scripts pm2 start ecosystem.config.js --env production && pm2 logs',
        ...
        source_scripts: '{}',
        unique_id: '36b27486-e706-447d-86f7-ced929487de8'
      },
      node_args: [ '--inspect' ],
      name: 'source_scripts',
      pm_exec_path: 'D:\\source\\edu-node-github\\app.js',
      pm_cwd: 'D:\\source\\edu-node-github',
      exec_interpreter: 'node',
      exec_mode: 'fork_mode',
      instances: 1,
      pm_out_log_path: 'C:\\Users\\xu\\.pm2\\logs\\source-scripts-out.log',
      pm_err_log_path: 'C:\\Users\\xu\\.pm2\\logs\\source-scripts-error.log',
      pm_pid_path: 'C:\\Users\\xu\\.pm2\\pids\\source-scripts-0.pid',
      km_link: true,
      ...
      axm_monitor: {
        ...
        'Active handles': { value: 4, type: 'internal/libuv/handles', historic: true },
        'Event Loop Latency': {
          value: '6.00',
      ...
      axm_options: {
        ...
        module_name: 'source_scripts',
        module_version: '5.1.2'
      },
      axm_dynamic: {},
      created_at: 1634543996909,
      pm_id: 0,
      restart_time: 2,
      unstable_restarts: 0,
      version: '1.0.0',
      ...
      versioning: {
        ...
        revision: '207fc3610b0c23acfbb07ba8ea1255ddc239093f',
        comment: "Merge branch 'master' into feature/login\n\n",
        unstaged: false,
        ...
        next_rev: null,
        prev_rev: null,
        update_time: '2021-10-18T07:59:57.831Z',
        repo_path: 'D:\\source\\edu-node-github'
      },
      prev_restart_delay: 0,
      exit_code: 1
    },
    pm_id: 0,
    monit: { memory: 53678080, cpu: 0 }
  },
  {
    pid: 33580,
    name: 'origin_master',
    pm2_env: {
      ...
      env: {
        ...
        TEMP: 'C:\\Users\\xu\\AppData\\Local\\Temp',
        TMP: 'C:\\Users\\xu\\AppData\\Local\\Temp',
        unique_id: '31788ea2-d6fb-41b0-9fb0-1bd2e5bcbe98',
        USERDOMAIN: 'LAPTOP-4KDIA4A3',
        USERDOMAIN_ROAMINGPROFILE: 'LAPTOP-4KDIA4A3',
        USERNAME: 'xu',
        USERPROFILE: 'C:\\Users\\xu',
      ...
      pm_pid_path: 'C:\\Users\\xu\\.pm2\\pids\\origin-master-1.pid',
      km_link: 'true',
      vizion_running: false,
      NODE_APP_INSTANCE: '0',
      ALLUSERSPROFILE: 'C:\\ProgramData',
      ...
      versioning: {
        ...
        update_time: '2021-10-18T07:59:13.052Z',
        repo_path: 'D:\\temp\\m-node-edu\\origin\\master'
      }
    },
    pm_id: 1,
    monit: { memory: 53948416, cpu: 0 }
  },
  {
    pid: 31808,
    name: 'origin_feature_login',
    pm2_env: {
      namespace: 'default',
      env_development: { NODE_ENV: 'development', PORT: 81 },
      env_production: { NODE_ENV: 'production', PORT: 81 },
      ...
      env: {
        ...
        TEMP: 'C:\\Users\\xu\\AppData\\Local\\Temp',
        TMP: 'C:\\Users\\xu\\AppData\\Local\\Temp',
        unique_id: 'd12e2f52-8a44-4d54-97d6-353cd5515ca0',
        USERDOMAIN: 'LAPTOP-4KDIA4A3',
        USERDOMAIN_ROAMINGPROFILE: 'LAPTOP-4KDIA4A3',
        USERNAME: 'xu',
        USERPROFILE: 'C:\\Users\\xu',
        ...
        WXDRIVE_START_ARGS: '--wxdrive-setting=0 --disable-gpu --disable-software-rasterizer --enable-features=NetworkServiceInProcess',
        YARN_WRAP_OUTPUT: 'false',
        origin_feature_login: '{}'
      },
      node_args: [ '--inspect' ],
      name: 'origin_feature_login',
      pm_exec_path: 'D:\\temp\\m-node-edu\\origin\\feature\\login\\app.js',
      pm_cwd: 'D:\\temp\\m-node-edu\\origin\\feature\\login',
      exec_interpreter: 'node',
      exec_mode: 'fork_mode',
      instances: 1,
      pm_out_log_path: 'C:\\Users\\xu\\.pm2\\logs\\origin-feature-login-out.log',
      pm_err_log_path: 'C:\\Users\\xu\\.pm2\\logs\\origin-feature-login-error.log',
      pm_pid_path: 'C:\\Users\\xu\\.pm2\\pids\\origin-feature-login-2.pid',
      km_link: 'true',
      vizion_running: false,
      NODE_APP_INSTANCE: '0',
      ALLUSERSPROFILE: 'C:\\ProgramData',
      ...
      axm_monitor: {
        ...
        'Active requests': { value: 14, type: 'internal/libuv/requests', historic: true },
        'Active handles': { value: 4, type: 'internal/libuv/handles', historic: true },
        'Event Loop Latency': {
          value: '204.48',
          type: 'internal/libuv/latency/p50',
      ...
      axm_options: {
        ...
        module_conf: {},
        apm: { version: '5.0.0', type: 'node' },
        module_name: 'origin_feature_login',
        module_version: '5.1.2'
      },
      axm_dynamic: {},
      created_at: 1634544035322,
      pm_id: 2,
      restart_time: 0,
      unstable_restarts: 0,
      versioning: {
        type: 'git',
        url: 'git@github.com:xutongbao/m-node-edu.git',
        revision: 'fb9c4df751823546c2353d9569550ddcc6c86e05',
        comment: "Merge branch 'master' into feature/login\n\n",
        unstaged: true,
        branch: 'HEAD',
        remotes: [ 'origin' ],
        ...
        ahead: false,
        next_rev: null,
        prev_rev: '2e0921557cff6332f0070f5ccf2e5008cabaef35',
        update_time: '2021-10-18T08:00:35.704Z',
        repo_path: 'D:\\temp\\m-node-edu\\origin\\feature\\login'
      }
    },
    pm_id: 2,
    monit: { memory: 80232448, cpu: 0 }
  }
]; 
