...
[
  {
    ...
    pm2_env: {
      ...
      npm_package_scripts_serve1: 'cross-env branch=origin/master PORT=81 NODE_ENV=production nodemon --inspect --ignore node_modules/ --ignore dbFile/ --ignore log app',
      ...
      npm_package_scripts_dev1: 'cross-env branch=origin/master PORT=81 NODE_ENV=development nodemon --inspect --ignore node_modules/ --ignore dbFile/ --ignore log app',
      ...
      npm_lifecycle_script: 'cross-env branch=origin/master PORT=81 NODE_ENV=development nodemon --inspect --ignore node_modules/ --ignore dbFile/ --ignore log app',
      ...
      origin_master: '{}',
      unique_id: 'ffeaf2e8-5ef3-48c6-90c8-8331cece83d6',
      status: 'online',
      pm_uptime: 1634288098866,
      axm_actions: [
        {
      ...
      versioning: {
        ...
        revision: '996577910ae05447426d324c915e01cd21011d94',
        comment: '优化\n',
        unstaged: true,
        branch: 'HEAD',
        remotes: [ 'origin' ],
        ...
        ahead: false,
        next_rev: null,
        prev_rev: 'b321f7eb6db40eff2d67dd6c88588eb8bbb21f53',
        update_time: '2021-10-15T08:54:59.278Z',
