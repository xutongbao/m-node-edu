...
[
  {
    ...
    pm2_env: {
      ...
      env: {
        ...
        origin_master: '{}',
        unique_id: 'e9e3c570-7c0d-4c74-a10a-72f7a8c299c1'
      },
      node_args: [ '--inspect' ],
      name: 'origin_master',
      ...
      versioning: {
        ...
        update_time: '2021-10-18T07:01:16.735Z',
        repo_path: 'D:\\temp\\m-node-edu\\origin\\master'
      }
    },
    pm_id: 0,
    monit: { memory: 79941632, cpu: 0 }
  }
]; 
