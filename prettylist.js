...
[
  {
    ...
    pm2_env: {
      ...
      env: {
        ...
        origin_master: '{}',
        unique_id: '4c795c20-85ea-42e6-bf0e-4bdb8ac7fdb4'
      },
      node_args: [ '--inspect' ],
      name: 'origin_master',
      ...
      versioning: {
        ...
        update_time: '2021-10-18T03:06:45.599Z',
        repo_path: 'D:\\temp\\m-node-edu\\origin\\master'
      }
    },
    pm_id: 0,
    monit: { memory: 79716352, cpu: 0 }
  }
]; 
